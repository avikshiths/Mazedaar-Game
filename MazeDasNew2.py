...
class Door(pg.sprite.Sprite) :
    ...
    def update(self) :
        ...
        if self.rect.colliderect(player.rect) :
            ...
            text = font.render(f'Mining the rock {self.time_second- (self.counter//fps)}', True,"#13002D")
            screen.blit(text, (MWIDTH2,HEIGHT/2))
...
def custom_draw() :
        ...
        text_data= "Keys left : "+ str(player.keys)
    ...
    while run :
        ...
        for event in pg.event.get() :
            if event.type == pg.MOUSEBUTTONDOWN :
                ...
                if event.button == 3 : question_grp.update()
